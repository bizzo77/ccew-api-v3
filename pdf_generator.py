...
def generate_ccew_pdf(form_data):
    ...
    c.setFillColor(white)
    c.setFont("Helvetica-Bold", 8)
    c.drawString(22*mm, section_start_y - 8*mm, "Property Name")
    c.drawString(22*mm, section_start_y - 16*mm, "Floor")
    c.drawString(48*mm, section_start_y - 16*mm, "Unit")
    c.drawString(74*mm, section_start_y - 16*mm, "*Street Number")
    c.drawString(115*mm, section_start_y - 16*mm, "&/or")
    c.drawString(129*mm, section_start_y - 16*mm, "Lot/RMB")
    c.drawString(22*mm, section_start_y - 24*mm, "*Street Name")
    c.drawString(110*mm, section_start_y - 24*mm, "Nearest Cross Street")
    c.drawString(22*mm, section_start_y - 32*mm, "*Suburb")
    c.drawString(110*mm, section_start_y - 32*mm, "*State")
    c.drawString(155*mm, section_start_y - 32*mm, "*Post Code")
    c.drawString(22*mm, section_start_y - 40*mm, "Pit/Pillar /Pole No.")
    c.drawString(65*mm, section_start_y - 40*mm, "NMI")
    c.drawString(100*mm, section_start_y - 40*mm, "Meter No.")
    c.drawString(135*mm, section_start_y - 40*mm, "AEMO Metering Provider I.D.")
    ...
    c.setFillColor(white)
    c.setFont("Helvetica-Bold", 8)
    c.drawString(22*mm, cust_section_start_y - 8*mm, "*First Name")
    c.drawString(110*mm, cust_section_start_y - 8*mm, "*Last Name")
    c.drawString(22*mm, cust_section_start_y - 16*mm, "Company Name")
    c.drawString(22*mm, cust_section_start_y - 24*mm, "Floor")
    c.drawString(48*mm, cust_section_start_y - 24*mm, "Unit")
    c.drawString(74*mm, cust_section_start_y - 24*mm, "*Street Number")
    c.drawString(115*mm, cust_section_start_y - 24*mm, "&/or")
    c.drawString(129*mm, cust_section_start_y - 24*mm, "Lot/RMB")
    c.drawString(22*mm, cust_section_start_y - 32*mm, "*Street Name")
    c.drawString(110*mm, cust_section_start_y - 32*mm, "Nearest Cross Street")
    c.drawString(22*mm, cust_section_start_y - 40*mm, "*Suburb")
    c.drawString(110*mm, cust_section_start_y - 40*mm, "*State")
    c.drawString(155*mm, cust_section_start_y - 40*mm, "*Post Code")
    c.drawString(22*mm, cust_section_start_y - 48*mm, "Email")
    c.drawString(115*mm, cust_section_start_y - 48*mm, "Office No.")
    c.drawString(155*mm, cust_section_start_y - 48*mm, "Mobile No.")
    ...
    c.setFont("Helvetica-Bold", 8)
    y_label = installers_section_start_y - 8*mm
    ...
    c.setFont("Helvetica-Bold", 8)
    y_label = testers_section_start_y - 8*mm
    c.drawString(22*mm, y_label, "*First Name")
    c.drawString(115*mm, y_label, "*Last Name")
