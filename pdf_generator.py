...
def generate_ccew_pdf(form_data):
    ...
    draw_field(c, 21*mm, section_start_y - 18*mm, 168*mm, 5*mm, form_data.get('property_name', ''))
    draw_field(c, 21*mm, section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, section_start_y - 26*mm, 35*mm, 5*mm, form_data.get('install_street_number', ''))
    draw_field(c, 128*mm, section_start_y - 26*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, section_start_y - 34*mm, 85*mm, 5*mm, form_data.get('install_street_name', ''))
    draw_field(c, 109*mm, section_start_y - 34*mm, 80*mm, 5*mm, form_data.get('nearest_cross_street', ''))
    draw_field(c, 21*mm, section_start_y - 42*mm, 85*mm, 5*mm, form_data.get('install_suburb', ''))
    draw_field(c, 109*mm, section_start_y - 42*mm, 42*mm, 5*mm, form_data.get('install_state', 'NSW'))
    draw_field(c, 154*mm, section_start_y - 42*mm, 35*mm, 5*mm, form_data.get('install_postcode', ''))
    draw_field(c, 21*mm, section_start_y - 50*mm, 40*mm, 5*mm, form_data.get('pit_pillar_pole_no', ''))
    draw_field(c, 64*mm, section_start_y - 50*mm, 32*mm, 5*mm, form_data.get('nmi', ''))
    draw_field(c, 99*mm, section_start_y - 50*mm, 32*mm, 5*mm, form_data.get('meter_no', ''))
    draw_field(c, 134*mm, section_start_y - 50*mm, 55*mm, 5*mm, form_data.get('aemo_provider_id', ''))
    ...
    draw_field(c, 109*mm, cust_section_start_y - 18*mm, 80*mm, 5*mm, form_data.get('customer_last_name', ''))
    draw_field(c, 21*mm, cust_section_start_y - 26*mm, 168*mm, 5*mm, form_data.get('customer_company_name', ''))
    draw_field(c, 21*mm, cust_section_start_y - 34*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, cust_section_start_y - 34*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, cust_section_start_y - 34*mm, 35*mm, 5*mm, form_data.get('customer_street_number', ''))
    draw_field(c, 128*mm, cust_section_start_y - 34*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, cust_section_start_y - 42*mm, 85*mm, 5*mm, form_data.get('customer_street_name', ''))
    draw_field(c, 109*mm, cust_section_start_y - 42*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, cust_section_start_y - 50*mm, 85*mm, 5*mm, form_data.get('customer_suburb', ''))
    draw_field(c, 109*mm, cust_section_start_y - 50*mm, 42*mm, 5*mm, form_data.get('customer_state', ''))
    draw_field(c, 154*mm, cust_section_start_y - 50*mm, 35*mm, 5*mm, form_data.get('customer_postcode', ''))
    draw_field(c, 21*mm, cust_section_start_y - 58*mm, 85*mm, 5*mm, form_data.get('customer_email', ''))
    draw_field(c, 109*mm, cust_section_start_y - 58*mm, 42*mm, 5*mm, form_data.get('customer_office_phone', ''))
    draw_field(c, 154*mm, cust_section_start_y - 58*mm, 35*mm, 5*mm, form_data.get('customer_mobile_phone', ''))
    ...
    # Redraw all field boxes on top of green background
    draw_field(c, 21*mm, installers_section_start_y - 18*mm, 85*mm, 5*mm, form_data.get('installer_first_name', ''))
    draw_field(c, 109*mm, installers_section_start_y - 18*mm, 80*mm, 5*mm, form_data.get('installer_last_name', ''))
    draw_field(c, 21*mm, installers_section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, installers_section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, installers_section_start_y - 26*mm, 35*mm, 5*mm, form_data.get('installer_street_number', ''))
    draw_field(c, 128*mm, installers_section_start_y - 26*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, installers_section_start_y - 34*mm, 85*mm, 5*mm, form_data.get('installer_street_name', ''))
    draw_field(c, 109*mm, installers_section_start_y - 34*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, installers_section_start_y - 42*mm, 85*mm, 5*mm, form_data.get('installer_suburb', ''))
    draw_field(c, 109*mm, installers_section_start_y - 42*mm, 42*mm, 5*mm, form_data.get('installer_state', ''))
    draw_field(c, 154*mm, installers_section_start_y - 42*mm, 35*mm, 5*mm, form_data.get('installer_postcode', ''))
    draw_field(c, 21*mm, installers_section_start_y - 50*mm, 85*mm, 5*mm, form_data.get('installer_email', ''))
    draw_field(c, 109*mm, installers_section_start_y - 50*mm, 42*mm, 5*mm, form_data.get('installer_office_phone', ''))
    draw_field(c, 154*mm, installers_section_start_y - 50*mm, 35*mm, 5*mm, form_data.get('installer_mobile_phone', ''))
    draw_field(c, 21*mm, installers_section_start_y - 58*mm, 40*mm, 5*mm, '')
    draw_field(c, 64*mm, installers_section_start_y - 58*mm, 28*mm, 5*mm, '')
    draw_field(c, 104*mm, installers_section_start_y - 58*mm, 47*mm, 5*mm, form_data.get('installer_license_no', ''))
    draw_field(c, 154*mm, installers_section_start_y - 58*mm, 35*mm, 5*mm, format_date_australian(form_data.get('installer_license_expiry', '')))
    ...
    # Redraw all field boxes on top of green background
    draw_field(c, 21*mm, testers_section_start_y - 18*mm, 85*mm, 5*mm, form_data.get('tester_first_name', ''))
    draw_field(c, 109*mm, testers_section_start_y - 18*mm, 80*mm, 5*mm, form_data.get('tester_last_name', ''))
    draw_field(c, 21*mm, testers_section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, testers_section_start_y - 26*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, testers_section_start_y - 26*mm, 35*mm, 5*mm, form_data.get('tester_street_number', ''))
    draw_field(c, 128*mm, testers_section_start_y - 26*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, testers_section_start_y - 34*mm, 85*mm, 5*mm, form_data.get('tester_street_name', ''))
    draw_field(c, 109*mm, testers_section_start_y - 34*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, testers_section_start_y - 42*mm, 85*mm, 5*mm, form_data.get('tester_suburb', ''))
    draw_field(c, 109*mm, testers_section_start_y - 42*mm, 42*mm, 5*mm, form_data.get('tester_state', ''))
    draw_field(c, 154*mm, testers_section_start_y - 42*mm, 35*mm, 5*mm, form_data.get('tester_postcode', ''))
    draw_field(c, 21*mm, testers_section_start_y - 50*mm, 85*mm, 5*mm, form_data.get('tester_email', ''))
    draw_field(c, 109*mm, testers_section_start_y - 50*mm, 42*mm, 5*mm, form_data.get('tester_office_phone', ''))
    draw_field(c, 154*mm, testers_section_start_y - 50*mm, 35*mm, 5*mm, form_data.get('tester_mobile_phone', ''))
    draw_field(c, 21*mm, testers_section_start_y - 58*mm, 40*mm, 5*mm, '')
    draw_field(c, 64*mm, testers_section_start_y - 58*mm, 28*mm, 5*mm, '')
    draw_field(c, 104*mm, testers_section_start_y - 58*mm, 47*mm, 5*mm, form_data.get('tester_license_no', ''))
    draw_field(c, 154*mm, testers_section_start_y - 58*mm, 35*mm, 5*mm, format_date_australian(form_data.get('tester_license_expiry', '')))
