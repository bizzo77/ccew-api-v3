...
def generate_ccew_pdf(form_data):
    ...
    c.drawString(77*mm, section_start_y - 21*mm, "*Street Number")
    c.drawString(115*mm, section_start_y - 21*mm, "&/or")
    c.drawString(130*mm, section_start_y - 21*mm, "Lot/RMB")
    c.drawString(22*mm, section_start_y - 29*mm, "*Street Name")
    c.drawString(115*mm, section_start_y - 29*mm, "Nearest Cross Street")
    c.drawString(22*mm, section_start_y - 37*mm, "*Suburb")
    c.drawString(115*mm, section_start_y - 37*mm, "*State")
    ...
    draw_field(c, 21*mm, section_start_y - 21*mm, 168*mm, 5*mm, form_data.get('property_name', ''))
    draw_field(c, 21*mm, section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, section_start_y - 29*mm, 35*mm, 5*mm, form_data.get('install_street_number', ''))
    draw_field(c, 128*mm, section_start_y - 29*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, section_start_y - 37*mm, 85*mm, 5*mm, form_data.get('install_street_name', ''))
    draw_field(c, 109*mm, section_start_y - 37*mm, 80*mm, 5*mm, form_data.get('nearest_cross_street', ''))
    draw_field(c, 21*mm, section_start_y - 45*mm, 85*mm, 5*mm, form_data.get('install_suburb', ''))
    draw_field(c, 109*mm, section_start_y - 45*mm, 42*mm, 5*mm, form_data.get('install_state', 'NSW'))
    draw_field(c, 154*mm, section_start_y - 45*mm, 35*mm, 5*mm, form_data.get('install_postcode', ''))
    draw_field(c, 21*mm, section_start_y - 53*mm, 40*mm, 5*mm, form_data.get('pit_pillar_pole_no', ''))
    draw_field(c, 64*mm, section_start_y - 53*mm, 32*mm, 5*mm, form_data.get('nmi', ''))
    draw_field(c, 99*mm, section_start_y - 53*mm, 32*mm, 5*mm, form_data.get('meter_no', ''))
    draw_field(c, 134*mm, section_start_y - 53*mm, 55*mm, 5*mm, form_data.get('aemo_provider_id', ''))
    ...
    # Redraw all field boxes on top of green background
    draw_field(c, 21*mm, cust_section_start_y - 21*mm, 85*mm, 5*mm, form_data.get('customer_first_name', ''))
    draw_field(c, 109*mm, cust_section_start_y - 21*mm, 80*mm, 5*mm, form_data.get('customer_last_name', ''))
    draw_field(c, 21*mm, cust_section_start_y - 29*mm, 168*mm, 5*mm, form_data.get('customer_company_name', ''))
    draw_field(c, 21*mm, cust_section_start_y - 37*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, cust_section_start_y - 37*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, cust_section_start_y - 37*mm, 35*mm, 5*mm, form_data.get('customer_street_number', ''))
    draw_field(c, 128*mm, cust_section_start_y - 37*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, cust_section_start_y - 45*mm, 85*mm, 5*mm, form_data.get('customer_street_name', ''))
    draw_field(c, 109*mm, cust_section_start_y - 45*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, cust_section_start_y - 53*mm, 85*mm, 5*mm, form_data.get('customer_suburb', ''))
    draw_field(c, 109*mm, cust_section_start_y - 53*mm, 42*mm, 5*mm, form_data.get('customer_state', ''))
    draw_field(c, 154*mm, cust_section_start_y - 53*mm, 35*mm, 5*mm, form_data.get('customer_postcode', ''))
    draw_field(c, 21*mm, cust_section_start_y - 61*mm, 85*mm, 5*mm, form_data.get('customer_email', ''))
    draw_field(c, 109*mm, cust_section_start_y - 61*mm, 42*mm, 5*mm, form_data.get('customer_office_phone', ''))
    draw_field(c, 154*mm, cust_section_start_y - 61*mm, 35*mm, 5*mm, form_data.get('customer_mobile_phone', ''))
    ...
    # Redraw all field boxes on top of green background
    draw_field(c, 21*mm, installers_section_start_y - 21*mm, 85*mm, 5*mm, form_data.get('installer_first_name', ''))
    draw_field(c, 109*mm, installers_section_start_y - 21*mm, 80*mm, 5*mm, form_data.get('installer_last_name', ''))
    draw_field(c, 21*mm, installers_section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, installers_section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, installers_section_start_y - 29*mm, 35*mm, 5*mm, form_data.get('installer_street_number', ''))
    draw_field(c, 128*mm, installers_section_start_y - 29*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, installers_section_start_y - 37*mm, 85*mm, 5*mm, form_data.get('installer_street_name', ''))
    draw_field(c, 109*mm, installers_section_start_y - 37*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, installers_section_start_y - 45*mm, 85*mm, 5*mm, form_data.get('installer_suburb', ''))
    draw_field(c, 109*mm, installers_section_start_y - 45*mm, 42*mm, 5*mm, form_data.get('installer_state', ''))
    draw_field(c, 154*mm, installers_section_start_y - 45*mm, 35*mm, 5*mm, form_data.get('installer_postcode', ''))
    draw_field(c, 21*mm, installers_section_start_y - 53*mm, 85*mm, 5*mm, form_data.get('installer_email', ''))
    draw_field(c, 109*mm, installers_section_start_y - 53*mm, 42*mm, 5*mm, form_data.get('installer_office_phone', ''))
    draw_field(c, 154*mm, installers_section_start_y - 53*mm, 35*mm, 5*mm, form_data.get('installer_mobile_phone', ''))
    draw_field(c, 21*mm, installers_section_start_y - 61*mm, 40*mm, 5*mm, '')
    draw_field(c, 64*mm, installers_section_start_y - 61*mm, 28*mm, 5*mm, '')
    draw_field(c, 104*mm, installers_section_start_y - 61*mm, 47*mm, 5*mm, form_data.get('installer_license_no', ''))
    draw_field(c, 154*mm, installers_section_start_y - 61*mm, 35*mm, 5*mm, format_date_australian(form_data.get('installer_license_expiry', '')))
    ...
    # Redraw all field boxes on top of green background
    draw_field(c, 21*mm, testers_section_start_y - 21*mm, 85*mm, 5*mm, form_data.get('tester_first_name', ''))
    draw_field(c, 109*mm, testers_section_start_y - 21*mm, 80*mm, 5*mm, form_data.get('tester_last_name', ''))
    draw_field(c, 21*mm, testers_section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 47*mm, testers_section_start_y - 29*mm, 23*mm, 5*mm, '')
    draw_field(c, 73*mm, testers_section_start_y - 29*mm, 35*mm, 5*mm, form_data.get('tester_street_number', ''))
    draw_field(c, 128*mm, testers_section_start_y - 29*mm, 61*mm, 5*mm, '')
    draw_field(c, 21*mm, testers_section_start_y - 37*mm, 85*mm, 5*mm, form_data.get('tester_street_name', ''))
    draw_field(c, 109*mm, testers_section_start_y - 37*mm, 80*mm, 5*mm, '')
    draw_field(c, 21*mm, testers_section_start_y - 45*mm, 85*mm, 5*mm, form_data.get('tester_suburb', ''))
    draw_field(c, 109*mm, testers_section_start_y - 45*mm, 42*mm, 5*mm, form_data.get('tester_state', ''))
    draw_field(c, 154*mm, testers_section_start_y - 45*mm, 35*mm, 5*mm, form_data.get('tester_postcode', ''))
    draw_field(c, 21*mm, testers_section_start_y - 53*mm, 85*mm, 5*mm, form_data.get('tester_email', ''))
    draw_field(c, 109*mm, testers_section_start_y - 53*mm, 42*mm, 5*mm, form_data.get('tester_office_phone', ''))
    draw_field(c, 154*mm, testers_section_start_y - 53*mm, 35*mm, 5*mm, form_data.get('tester_mobile_phone', ''))
    draw_field(c, 21*mm, testers_section_start_y - 61*mm, 40*mm, 5*mm, '')
    draw_field(c, 64*mm, testers_section_start_y - 61*mm, 28*mm, 5*mm, '')
    draw_field(c, 104*mm, testers_section_start_y - 61*mm, 47*mm, 5*mm, form_data.get('tester_license_no', ''))
    draw_field(c, 154*mm, testers_section_start_y - 61*mm, 35*mm, 5*mm, format_date_australian(form_data.get('tester_license_expiry', '')))
